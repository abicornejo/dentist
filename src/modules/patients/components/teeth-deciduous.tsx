  ...
  render() {
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 55) ? (this.state.statusDoneTeeth.includes(55) ? "#369661" : "#DE2527")
                : selectedTeeth.includes(55) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={this.state.selectedTeeth.includes(55) ? isMissing ? `M12634.4-1944.9c-5.1-15.8-15.3-47.3-85.8-26.4
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 55)
                ? (this.state.statusDoneTeeth.includes(55) ? "#369661" : "#DE2527")
                : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(55) ? isMissing ? `M12382.9-1676.7
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 54)
                ...
                : selectedTeeth.includes(54) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(54) ? isMissing ? `M13741.6-1884.8
	...
	c0-70-10.2-70-50.1-131.3c-45-70-50.1-65.4-59.8-148.4l-5.1-61.2L13741.6-1884.8L13741.6-1884.8L13741.6-1884.8z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(54) ? isMissing ? `M13461.8-1613.9c-54.7,48.2-160,179.1-45,257.9
	...
	c14.8,13,34.8,17.6,45,21.8l124.8,48.2`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(54) ? isMissing ? `M13236.9-1718.7c64.9,39.4,90,100.7,120.1,153.1
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 53)
                ...
                : selectedTeeth.includes(53) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(53) ? isMissing ? `M14389.9-1907.9
	...
	L14389.9-1907.9z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(53) ? isMissing ? `M14136.6-1359.1c38.5-108.1,9.7-197.6-96-284.8` : '' : `M14136.6-1359.1c38.5-108.1,9.7-197.6-96-284.8`}
          />
          <path
            fill="#FAFAFA"
            stroke={
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 52)
                ...
                : selectedTeeth.includes(52) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(52) ? isMissing ? `M15356.1-1302.9c10.2,97.4-71,97.4-157.3,93.2
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 51)
                ...
                : selectedTeeth.includes(51) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(51) ? isMissing ? `M15973.5-1783.9c3.7,7,0,13.5,0,17.2
	...
	c92.8,13.5,149.4,68.2,202.7,122.5C15959.6-1801.1,15970.3-1790.9,15973.5-1783.9L15973.5-1783.9L15973.5-1783.9z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(51) ? isMissing ? `M15911.8-1163.7c-5.6-63.1-5.6-105.8,2.8-156.3
	...
	c-92.3,243.5-122.9,486.6-143.8,814.6c-10.2,109,10.2,198.5,35.7,273.2c25.5-9.7,77,59.8,102.5,49.6L19885.1-1857L19885.1-1857z"
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 65)
                ? (this.state.statusDoneTeeth.includes(65) ? "#369661" : "#DE2527")
                : selectedTeeth.includes(65) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(65) ? isMissing ? `M19599.3-1907.6c5.1-15.8,15.3-47.3,85.8-26.4
	...
	C19423.1-1655.2,19553.9-1781.4,19599.3-1907.6L19599.3-1907.6z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(65) ? isMissing ? `M19926.4-1381.5c25.1-84.4-5.1-184.1-75.6-257.9
	...
	c51.5,128.5,51.5,114.1,45.5,256.5v223.1l120.1,9.7L18847.5-1942L18847.5-1942z"
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 64)
                ? (this.state.statusDoneTeeth.includes(64) ? "#369661" : "#DE2527")
                : selectedTeeth.includes(64) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(64) ? isMissing ? `M18492.1-1847.4
	...
	c0-70,10.2-70,50.1-131.3c45-70,50.1-65.4,59.8-148.4l5.1-61.2L18492.1-1847.4L18492.1-1847.4L18492.1-1847.4z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(64) ? isMissing ? `M18771.9-1576.5c54.7,48.2,160,179.1,45,257.9
	...
	c-14.8,13-34.8,17.6-45,21.8l-124.8,48.2`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(64) ? isMissing ? `M18996.8-1681.3
	...
	C17828.4-2812.3,17835.3-2185.6,17845.5-1832.1L17845.5-1832.1z"
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 63)
                ? (this.state.statusDoneTeeth.includes(63) ? "#369661" : "#DE2527")
                : selectedTeeth.includes(63) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(63) ? isMissing ? `M17843.7-1870.6
	...
	L17843.7-1870.6z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(63) ? isMissing ? `M18097-1321.8c-38.5-108.1-9.7-197.6,96-284.8` : '' : `M18097-1321.8c-38.5-108.1-9.7-197.6,96-284.8`}
          />
	...
	c0,26.9-9.7,61.7-9.7,84.9c-33.9,374.4,72.4,779.8,14.4,899.5c-14.4,31.1-24.1,65.4-38.5,84.9L17350.7-1643.1z"
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 62)
                ? (this.state.statusDoneTeeth.includes(62) ? "#369661" : "#DE2527")
                : selectedTeeth.includes(62) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(62) ? isMissing ? `M16877.5-1265.5c-10.2,97.4,71,97.4,157.3,93.2
	...
	c-40.4,143.8-60.8,377.6-20.4,574.8L16526.5-1658.9z"
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 61)
                ? (this.state.statusDoneTeeth.includes(61) ? "#369661" : "#DE2527")
                : selectedTeeth.includes(61) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(61) ? isMissing ? `M16260.2-1746.5c-3.7,7,0,13.5,0,17.2
	...
	c-92.8,13.5-149.4,68.2-202.7,122.5C16274.1-1763.7,16263.4-1753.5,16260.2-1746.5L16260.2-1746.5L16260.2-1746.5z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(61) ? isMissing ? `M16319.1-1282.6c8.4,50.5,8.4,93.2,2.8,156.3
	...
	c182.3,71.9,458.3-623.5,463.4-780.7c15.8-85.4,10.2-376.7-20.9-439.8L12229.5,2782.8L12229.5,2782.8z"
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 85)
                ? (this.state.statusDoneTeeth.includes(85) ? "#369661" : "#DE2527")
                : selectedTeeth.includes(85) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(85) ? isMissing ? `M12599.3,2339.8
	...
	c58.5-121.5-127.1-275.6-180-317.8c-32-13.9-68.7-9.3-100.7,0C12726.4,2236.8,12641.5,2288.3,12599.3,2339.8L12599.3,2339.8z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(85) ? isMissing ? `M12598.9,2324.5
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 84)
                ...
                : selectedTeeth.includes(84) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(84) ? isMissing ? `M14199,2324.9c31.1,154.5,15.8,264.9-10.7,405.9
	...
	c145.7-17.6,234.3,101.6,244.9,92.8c31.1-22.3,177.2-114.6,276-119.2C14110.4,2179.2,14183.2,2267.4,14199,2324.9L14199,2324.9z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(84) ? isMissing ? `M13683.2,2571.6
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 83)
                ...
                : selectedTeeth.includes(83) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(83) ? isMissing ? `M14895.1,2273.9c-26-38-189.7-155.4-257-155.4
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 82)
                ...
                : selectedTeeth.includes(82) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(82) ? isMissing ? `M15460.9,2295.7c0-53.8-45-140.6-90-154.9
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 71)
                ...
                : selectedTeeth.includes(71) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(71) ? isMissing ? `M16188.8,2244L16188.8,2244
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 81)
                ...
                : selectedTeeth.includes(81) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(81) ? isMissing ? `M16149.8,2261.3L16149.8,2261.3
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 72)
                ...
                : selectedTeeth.includes(72) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(72) ? isMissing ? `M16871.7,2295.7c0-53.8,45-140.6,90-154.9
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 73)
                ...
                : selectedTeeth.includes(73) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(73) ? isMissing ? `M17429.3,2273.9
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 74)
                ...
                : selectedTeeth.includes(74) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(74) ? isMissing ? `M18062.3,2245.6
	...
	L18062.3,2245.6z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(74) ? isMissing ? `M18556.3,2232.1
          ...
          <path
            ...
            stroke={
              this.isShownRedGraphic("prosthetics", "", 75)
                ...
                : selectedTeeth.includes(75) && isImpacted ? "#095" : "#010101"
            }
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(75) ? isMissing ? `M19675.3,2270.7
	...
	c-58.5-121.5,127.1-275.6,180-317.8c32-13.9,68.7-9.3,100.7,0C19548.2,2167.7,19633.1,2219.2,19675.3,2270.7L19675.3,2270.7z`}
          ...
          <path
            ...
            strokeWidth="10"
            strokeMiterlimit="10"
            d={selectedTeeth.includes(75) ? isMissing ? `M19744.4,2451.6c5.1-70-26.4-149.4-68.7-196.2
